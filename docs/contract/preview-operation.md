...
to handle every scenario. For example, a preview might not be meaningful when identifiers,
...
When the extension cannot produce any meaningful preview because identifiers, configuration, or other

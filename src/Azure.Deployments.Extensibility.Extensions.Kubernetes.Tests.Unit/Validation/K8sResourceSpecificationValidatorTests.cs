...
{
    public class K8sResourceSpecificationValidatorTests
    {
        [Theory, AutoData]
        internal void Validate_InvalidTypeNullApiVersionNullConfig_ReturnsError(Fixture fixture, K8sResourceSpecificationValidator sut)
        {
        ...
        [Theory, AutoData]
        internal void Validate_InvalidApiVersionInvalidConfig_ReturnsError(Fixture fixture, K8sResourceSpecificationValidator sut)
        {
        ...
        [Theory, AutoData]
        internal void Validate_InvalidPropertiesNullConfig_ReturnsError(Fixture fixture, K8sResourceSpecificationValidator sut)
        {
            var invalidResourceReference = fixture.Build<ResourceSpecification>()
                .With(x => x.Type, "apps/Deployment")
        ...
        [Theory, AutoData]
        internal void Validate_ValidReference_ReturnsNull(Fixture fixture, K8sResourceSpecificationValidator sut)
        {
            var invalidResourceReference = fixture.Build<ResourceSpecification>()
                .With(x => x.Type, "apps/Deployment")
                .With(x => x.ApiVersion, "v1")

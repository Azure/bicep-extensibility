...
/// </summary>
public interface IResourceCreateOrUpdateHandler : IHandler
{
    /// <summary>
    ...
    Task<OneOf<Resource, LongRunningOperation, ErrorResponse>> HandleAsync(ResourceSpecification resourceSpecification, CancellationToken cancellationToken);
}

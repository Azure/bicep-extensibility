    ...
    ILongRunningOperationGetDecorator
{
    ...
    async Task<OneOf<ResourcePreview, ErrorResponse>> IResourcePreviewDecorator.HandleAsync(
    ...
    async Task<OneOf<Resource, LongRunningOperation, ErrorResponse>> IResourceCreateOrUpdateDecorator.HandleAsync(
    ...
    async Task<OneOf<Resource?, ErrorResponse>> IResourceGetDecorator.HandleAsync(
    ...
    async Task<OneOf<Resource?, LongRunningOperation, ErrorResponse>> IResourceDeleteDecorator.HandleAsync(
    ...
    async Task<OneOf<LongRunningOperation, ErrorResponse>> ILongRunningOperationGetDecorator.HandleAsync(
